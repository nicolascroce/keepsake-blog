...
![Company profile in Keepsake](/fiche%20entreprise.png)
...
But it doesn't stop there. The real power of company profiles in [Keepsake](https://keepsake.place?ref=blog) is that they bring together, in one place, everything happening around that company.
...
![Tasks linked to a company in Keepsake](/taches.png)
...
![Notes linked to a company in Keepsake](/notes.png)
...
![Interaction history in Keepsake](/historique.png)

Company profiles are already live.

Open [Keepsake](https://keepsake.place?ref=blog) and try it.

And as always, if you have a question or a suggestion, reach out at [support@keepsake.place](mailto:support@keepsake.place).
